...
public class QueryServiceImpl {
 ...
 /*   public Object findAll() {
        // 执行查询集合中全部文档信息
        List<Msg> documentList = mongoTemplate.findAll(Msg.class, COLLECTION_NAME);
        // 输出结果
        for (Msg msg : documentList) {
            log.info("用户信息：{}", msg);
        }
        return documentList;
    }*/
...
/*    public Object findById(String id) {
        ...
        Msg msg = mongoTemplate.findById(id, Msg.class, COLLECTION_NAME);
        // 输出结果
        log.info("用户信息：{}", msg);
        return msg;
    }*/
  ...
  /*  public Object findOne() {
        ...
        Msg msg = mongoTemplate.findOne(query, Msg.class, COLLECTION_NAME);
        // 输出结果
        log.info("用户信息：{}", msg);
        return msg;
    }*/
    ...
    public List<Msg> findByCondition(String toUserId,String state) {
        // 创建条件对象
        Criteria state1 = Criteria.where("state").is(state);
        Criteria toUserId1 = Criteria.where("toUserId").is(toUserId);
        // 创建查询对象，然后将条件对象添加到其中
        Criteria criteria = new Criteria().andOperator(state1, toUserId1);
        Query query = new Query(criteria);
        // 查询并返回结果
        List<Msg> documentList = mongoTemplate.find(query, Msg.class, COLLECTION_NAME);
        // 输出结果
        for (Msg msg : documentList) {
            log.info("用户信息：{}", msg);
        }
...
*/
   ...
   /* public Object countNumber() {
        ...
        Query query = new Query(criteria);
        // 查询并返回结果
        long count = mongoTemplate.count(query, Msg.class, COLLECTION_NAME);
        // 输出结果
