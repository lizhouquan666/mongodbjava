...
/**
    ...
    public Object findAndRemove() {
        ...
        Msg result = mongoTemplate.findAndRemove(query, Msg.class, COLLECTION_NAME);
        // 输出结果信息
...
/**
    ...
    public Object findAllAndRemove() {
        ...
        List<Msg> resultList = mongoTemplate.findAllAndRemove(query, Msg.class, COLLECTION_NAME);
        // 输出结果信息
